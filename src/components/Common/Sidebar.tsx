  ...
  return (
    <>
      ...
      >
        {!isMobile && (
          <Link to="/" className="flex items-center gap-3">
            ...
            <h1 className="text-xl text-white tracking-widest font-semibold uppercase">
              <span>Phê</span>
              <span className="text-primary">Phim</span>
            </h1>
          </Link>
        )}
        ...
        <div className="text-white text-lg font-medium mt-12">Cá nhân</div>
        <div className="mt-8 ml-4 flex flex-col gap-6">
          <button
        ...
        <div className="text-white text-lg font-medium mt-12">Chung</div>
        <div className="mt-8 ml-4 flex flex-col gap-6">
          <button
