...
const FilmItem: React.FC<FilmItemProps> = ({ item, onClick }) => {
  const handleClick = () => {
    if (onClick) {
  ...
  return (
    ...
    >
      <div
        className="shadow-sm bg-dark-darken pb-2 rounded-md overflow-hidden hover:scale-105 hover:brightness-110 transition duration-300 relative group"
        onClick={handleClick} // Attach the handleClick function to the div
      >
        <LazyLoadImage
          alt="Poster film"
          src={
